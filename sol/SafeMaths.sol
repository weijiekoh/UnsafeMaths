...
/**
 * A modified SafeMath contract. Functions are no longer internal and revert
 * reasons are removed. This allows us to more easily compare the gas
 * consumption with those defined in UnsafeMaths.huff.
 */
